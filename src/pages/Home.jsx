  ...
  return (
    <div>
      ...
      >
        ...
        <div className="videoHome relative  w-[100%] mx-3 my-12 z-10 ">
          <div className=" absolute w-[100%] h-[100%]  videoShadow -z-10 "></div>
...
root.render(<Hello />)}`}
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        ...
        <div className="mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7">
          <div className="flex lg:flex-row gap-5 mb-10 mt-[95px]  flex-col items-center justify-center">
            <div className="text-4xl font-semibold lg:w-[45%]">
              Get the Skills you need for a
              <HighlightText text={" Job that is in demand"} />
            </div>

            <div className="flex flex-col gap-10 lg:marker:w-[40%] items-start">
